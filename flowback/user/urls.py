...
user_patterns = [
    ...
    path('forgot_password/verify', UserForgotPasswordVerifyApi.as_view(),
         name='forgot_password_verify'),
    path('reset_password/verify', UserResetPasswordVerifyApi.as_view(),
    ...
    path('user/schedule/create', UserScheduleEventCreateAPI.as_view(),
         name='user_schedule_create'),
    path('user/schedule/update', UserScheduleEventUpdateAPI.as_view(),
         name='user_schedule_update'),
    path('user/schedule/delete', UserScheduleEventDeleteAPI.as_view(),
         name='user_schedule_delete'),
    path('user/schedule/unsubscribe', UserScheduleUnsubscribeAPI.as_view(),
         name='user_schedule_unsubscribe'),

    path('user/kanban/entry/list', UserKanbanEntryListAPI.as_view(),
         name='user_kanban_entry'),
    path('user/kanban/entry/create', UserKanbanEntryCreateAPI.as_view(),
         name='user_kanban_entry_create'),
    path('user/kanban/entry/update', UserKanbanEntryUpdateAPI.as_view(),
         name='user_kanban_entry_update'),
    path('user/kanban/entry/delete', UserKanbanEntryDeleteAPI.as_view(),
         name='user_kanban_entry_delete'),
]
DISABLE_DEFAULT_USER_REGISTRATION = False
if not DISABLE_DEFAULT_USER_REGISTRATION:
    user_patterns += [
        path('register', UserCreateApi.as_view(), name='register'),
        path('register/verify', UserCreateVerifyApi.as_view(),
